...
const Timer = () => {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen ${modeColors[mode].bg} p-6 sm:p-8`}>
        <nav className="flex justify-between items-center mb-4">
          <h1 className="text-2xl sm:text-3xl font-bold text-white">Pomodoro Timer</h1>
          <button
            className={`px-3 py-1 sm:px-4 sm:py-2 bg-white ${modeColors[mode].text} rounded-full text-base sm:text-lg`}
        ...
        <div className="max-w-sm sm:max-w-md mx-auto bg-white bg-opacity-20 backdrop-blur-md p-4 sm:p-8 rounded-lg shadow-lg">
          <div className="flex justify-center space-x-2 sm:space-x-4 mb-4 sm:mb-8">
            {['pomodoro', 'shortBreak', 'longBreak'].map((timerMode) => (
              <button
                key={timerMode}
                className={`px-3 py-1 sm:px-4 sm:py-2 rounded-full text-base sm:text-lg ${
          ...
          <div className="flex justify-center mb-4 sm:mb-8">
            <button
              className="px-7 py-2 sm:px-10 sm:py-3 bg-white text-red-600 rounded-full text-xl sm:text-2xl font-semibold"
              onClick={toggleTimer}
            >
          ...
          {showAboutModal && (
            ...
            >
              ...
              >
                ...
                <p className="mb-2 sm:mb-4 text-gray-700 text-base sm:text-lg">
                ...
                <ol className="list-decimal list-inside mb-2 sm:mb-4 text-gray-700 text-base sm:text-lg">
                ...
                <div className="flex justify-between">
                  <button
                    className="px-3 py-1 sm:px-4 sm:py-2 bg-blue-500 text-white rounded-full text-base sm:text-lg"
                    onClick={openPerplexitySearch}
                  >
                    Learn More
                  </button>
                  <button
                    className="px-3 py-1 sm:px-4 sm:py-2 bg-red-500 text-white rounded-full text-base sm:text-lg"
                    onClick={toggleAboutModal}
                  >
                    Close
                  </button>
